...
@section('content')
    ...
    <div class="mb-8 flex justify-between items-center">
        <h1 class="text-2xl font-bold text-gray-900">Daftar Perusahaan</h1>
    ...
    @endif
    <!-- Filters -->
    <div class="mb-8 p-8 bg-white rounded-xl border border-gray-100 shadow-sm">
        <form action="{{ route('companies.index') }}" method="GET">
            <div class="flex flex-row gap-6">
                <div class="w-1/3">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="search" id="search" value="{{ request('search') }}"
                            class="block w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:border-gray-400 focus:ring focus:ring-gray-200 focus:ring-opacity-50"
                ...
                <div class="w-1/3">
                    ...
                    <button type="submit" class="w-full px-4 py-2.5 text-sm font-medium text-white bg-gray-900 rounded-lg hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition duration-150">
                        Terapkan Filter
                    </button>
                </div>
            </div>
                    ...
                    @forelse($companies as $company)
                        <tr class="hover:bg-gray-50 transition duration-150">
                                ...
                                <div class="flex items-center">
                                    @if($company->logo)
                                        <div class="flex-shrink-0 h-12 w-12">
                                            <img class="h-12 w-12 rounded-lg object-cover border border-gray-100" 
                                                src="{{ $company->logo_url }}" 
                                                alt="{{ $company->name }}">
                                        </div>
                                    @else
                                        <div class="flex-shrink-0 h-12 w-12 rounded-lg bg-gray-50 border border-gray-100 flex items-center justify-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        @if($company->website)
                                            <a href="{{ $company->website }}" target="_blank" class="text-sm text-gray-500 hover:text-gray-700 transition duration-150">
                                                {{ str($company->website)->replace(['https://', 'http://'], '')->limit(30) }}
                                            </a>
                                        @endif
                                    </div>
                                </div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                @else
                                    <span class="inline-flex items-center px-2.5 py-1.5 rounded-md text-xs font-medium bg-yellow-50 text-yellow-800 border border-yellow-100">
                                        <svg class="w-4 h-4 mr-1.5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-10 whitespace-nowrap text-sm text-gray-500 text-center bg-gray-50">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-gray-500 mb-1">Tidak ada perusahaan yang ditemukan</p>
