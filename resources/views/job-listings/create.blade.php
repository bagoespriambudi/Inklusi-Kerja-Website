...
@section('content')
    <div class="bg-white rounded-xl border border-gray-100 shadow-sm">
        <form action="{{ route('job-listings.store') }}" method="POST" class="p-8 space-y-8">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-8">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="salary_range" id="salary_range" value="{{ old('salary_range') }}" required
                ...
                <div class="space-y-8">
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="description" id="description" rows="5" required
                            ...
                            placeholder="Masukkan deskripsi pekerjaan">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="requirements" id="requirements" rows="5" required
                            ...
                            placeholder="Masukkan persyaratan pekerjaan">{{ old('requirements') }}</textarea>
                        @error('requirements')
                            <p class="text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="benefits" id="benefits" rows="5" required
                            ...
                            placeholder="Masukkan benefit pekerjaan">{{ old('benefits') }}</textarea>
                        @error('benefits')
                            <p class="text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
