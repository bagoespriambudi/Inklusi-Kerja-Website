            ...
            @if(auth()->user()->role === 'admin')
                ...
                <div class="space-y-1">
                    ...
                    <a href="{{ route('admin.subscription-transactions.index') }}" 
                        class="flex items-center px-2 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('admin.subscription-transactions.*') ? 'text-gray-900 bg-gray-100' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }} transition-colors duration-200">
                        <svg class="w-5 h-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <a href="{{ route('subscription-plans.index') }}" 
                        class="flex items-center px-2 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('subscription-plans.*') ? 'text-gray-900 bg-gray-100' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }} transition-colors duration-200">
                        <svg class="w-5 h-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
