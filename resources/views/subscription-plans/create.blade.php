...
@section('title', 'Tambah Paket Berlangganan')

@section('content')
    <div class="bg-white rounded-xl border border-gray-100 shadow-sm">
        <form action="{{ route('subscription-plans.store') }}" method="POST" class="p-8 space-y-8">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-8">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="number" name="duration_in_days" id="duration_in_days" value="{{ old('duration_in_days') }}"
                            required
